...
r = GenerateEllipse(r, [19.75,19.75], 10,2.5);
...
dir =  '/home/woates/Documents/mdgraph/2DHoleClean/figures4/'
name = 'AtomPositions';
str = 'CrystalSeparate';
...
directory = '/home/woates/Documents/mdgraph/2DHoleClean/figures4/';
str = 'Crystal';
...
for i = 1:1
    ...
    Fs = Fsp - Fsn;
    Fpc = Afp.*(Ar<distance(i));
    Fnc = Afn.*(Ar<distance(i));
    Fc = Fpc - Fnc;
    data(i).Fs = Fs;
    data(i).Fc = Fc;
