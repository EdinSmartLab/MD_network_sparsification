...
%         r = GenerateHole(r, [9.75,9.75], 5);
        ...
        if updateFrequency == 0
            ...
            updatePairList();
            coulombList = AdjtoList(coulombList);
        end
        ...
        %aljy = aljy*0;
        tic
        [acx, acy] = forceCalcCList(r, full(coulombList), q, paramC.k);
